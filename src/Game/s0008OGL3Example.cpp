...
namespace
{
	...
	bool LightingTechnique::Init()
	{
		...
		if (!addShader(GL_VERTEX_SHADER, "shaders/0008lighting.vs")) {
			return false;
		}

		if (!addShader(GL_FRAGMENT_SHADER, "shaders/0008lighting.fs")) {
			return false;
		}
...
//=============================================================================
s0008OGL3Example::~s0008OGL3Example()
{
...
void s0008OGL3Example::OnStart()
{
	...
	Vector3f CameraPos(0.0f, 0.0f, -0.5f);
	Vector3f CameraTarget(0.0f, 0.0f, 1.0f);
	Vector3f CameraUp(0.0f, 1.0f, 0.0f);

	pGameCamera = new utils::CameraTemp(windowWidth, windowHeight, CameraPos, CameraTarget, CameraUp);

	mesh = new utils::Mesh("Data/Mesh/antique_ceramic_vase_01_4k.blend/antique_ceramic_vase_01_4k.obj");
...
//=============================================================================
void s0008OGL3Example::OnResize(uint32_t width, uint32_t height)
{
...
//=============================================================================
void s0008OGL3Example::OnMouseMove(int xpos, int ypos)
{
	if (firstMouse)
	{
		cursorLastX = xpos;
...
//=============================================================================
void s0008OGL3Example::OnUpdate(float deltaTime)
{
	//if (glfwGetKey(m_window, GLFW_KEY_W) == GLFW_PRESS)
}
//=============================================================================
void s0008OGL3Example::OnRender()
{
...
//=============================================================================
void s0008OGL3Example::OnImGuiDraw()
{
